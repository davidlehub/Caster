...
def Notify_AppContextMathed(aAppContext_data): #id20200315080523
    pass
    # #--- aAppContext_data: exemple, 'AppContext(['code'], ['visual studio code'], False)'

    # #region--- set exclusiveness For Rule(S) related to the matched App context

    # #--- Find out witch rule matched..
    # # gl.all_MappingRule_className
    # # gl.all_MergeRules_className
    # for i in gl.all_MappingRule_className
